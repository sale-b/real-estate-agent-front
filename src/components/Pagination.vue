<template>
  <ul class="pagination" :class="paginationClass">
    ...
    >
      <a id="cca" class="cc page-link" aria-label="Previous" @click="prevPage">
    ...
    >
      <a class="cc page-link" @click="changePage(item)">{{ item }}</a>
    </li>
    <li
      class="page-item page-pre next-page"
      :class="{ disabled: value === totalPages, 'no-arrows': noArrows }"
    >
      <a class="cc page-link" aria-label="Next" @click="nextPage">
